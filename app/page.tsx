      ...
      <div className="container max-w-6xl mx-auto flex flex-col items-center gap-8">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl">
            Descubra seu perfil como fã da FURIA e ajude-nos a conhecer melhor nossa comunidade.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
          <Card className="bg-gray-800 border-gray-700 shadow-xl">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Crie sua conta e descubra seu perfil de fã</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-4">
              <p className="text-gray-300">
                Responda a um questionário interativo, conecte suas redes sociais e descubra que tipo de fã da FURIA
                você é!
              </p>
            </CardContent>
            <CardFooter>
          ...
          <Card className="bg-gray-800 border-gray-700 shadow-xl">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Faça login para continuar sua jornada</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-4">
              <p className="text-gray-300">
                Continue de onde parou, atualize seu perfil e veja como sua relação com a FURIA evolui ao longo do
                tempo.
              </p>
            </CardContent>
            <CardFooter>
